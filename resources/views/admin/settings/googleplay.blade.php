@extends('global.main')
@section('title',"Google Play Settings")
@section('description',"Google Play Settings")
@section('innerTitle',"Google Play Settings")
@section('breadcrumb',"")
    ...
    <form role="form" action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="google_play_status">
                <option {{ old('google_play_status',$settings->google_play_status) == "OFF" ? 'selected' : '' }} value="OFF">OFF</option>
                <option {{ old('google_play_status',$settings->google_play_status) == "ON" ? 'selected' : '' }} value="ON">ON</option>
            </select>
        </div>
